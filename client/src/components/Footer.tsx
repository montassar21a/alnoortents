/* ============================================================
   AL NOOR TENTS — Footer
   Dark luxury footer with logo, links, social, copyright
   ============================================================ */
      ...
      <div className="container py-16 md:py-20">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer"
                className="text-white/30 hover:text-[oklch(0.72_0.12_75)] transition-colors" aria-label="WhatsApp">
              ...
              <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer"
                className="text-white/30 hover:text-[oklch(0.72_0.12_75)] transition-colors" aria-label="Instagram">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href={FACEBOOK_URL} target="_blank" rel="noopener noreferrer"
                className="text-white/30 hover:text-[oklch(0.72_0.12_75)] transition-colors" aria-label="Facebook">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              {quickLinks.map((link) => (
                <li key={link.labelKey}>
                  <button
                    ...
                    className="text-white/40 hover:text-[oklch(0.72_0.12_75)] transition-colors text-left"
                    style={{
                      fontFamily: lang === "ar" ? "'Noto Naskh Arabic', sans-serif" : "'DM Sans', sans-serif",
                      fontSize: "0.85rem",
                      fontWeight: 300,
        ...
        >
          ...
          <button
            ...
            className="text-white/25 hover:text-[oklch(0.72_0.12_75)] transition-colors"
            style={{
              fontFamily: "'DM Sans', sans-serif",
              fontSize: "0.7rem",
